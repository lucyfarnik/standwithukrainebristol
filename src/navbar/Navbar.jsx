...
export default function Navbar() {
    return (
        <nav className="invisible md:visible fixed bg-white top-0 left-0 right-0 h-16 z-50 border-b-4 border-b-flag-top flex justify-evenly items-center">
            <NavbarLink
                to="home"
                text={
                    <img
                        src={flag}
                        alt="Ukrainian flag"
                        className="h-8 border-2 border-white rounded-lg"
                    />
                }
            />
